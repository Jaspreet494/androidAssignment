...
/**
 * A class which create a DB on starting the application
 */
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    //Create the database, first time the application is installed on phone
    @Override
    ...
    //If we have to upgrade the database, then this code works
    @Override
